...
class BoardManager():
    ...
    def do_movement(self):
        ...
        if self.board_p1.lock_in_timer == 30:
            ...
            self.sound_manager.click()

            if self.board_p1.clear_lines(self.board_p1.get_full_lines()):
                self.sound_manager.bubble()
        ...
        if self.local_multi:
            ...
            if self.board_p2.lock_in_timer == 30:
                ...
                if self.board_p2.clear_lines(self.board_p2.get_full_lines()):
                    self.sound_manager.bubble
